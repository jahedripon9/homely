        ...
        <Row className={classes.row}>
            ...
            <div className={classes.info}>
              ...
              <div className={classes.content_div}>
                ...
                <p>
                  ...
                  by&nbsp;
                  <a
                    href="https://github.com/jahedripon9"
                    target="_blank"
                    rel="noreferrer"
                    className={classes.jahed_codes}
                  >
                    Jahed Ahmed Ripon
                  </a>
                </p>
          ...
          <Col lg={3}>
            <div className={classes.social}>
              <h3>Social</h3>
              <a
                href="https://www.instagram.com/jahed.ripon/"
                target="_blank"
                rel="noreferrer"
              >
                <p>
              ...
              <a
                href="https://mobile.twitter.com/jahed_ripon/"
                target="_blank"
                rel="noreferrer"
              >
                <p>
              ...
              <a
                href="https://www.facebook.com/JahedRipoN9/"
                target="_blank"
                rel="noreferrer"
              >
                <p>
